...
test.describe('Login Page', () => {
  test('renders login form with branding', async ({ page, takeScreenshot }) => {
    // NOTE: page.goto('/') is allowed for initial login page per convention
    await page.goto('/');
    ...
    await expect(page.locator('.login-card__header p')).toHaveText('Self-hosted email service');
...
test.describe('Logout', () => {
  test('logout returns to login page', async ({ page, loginAs, takeScreenshot }) => {
    ...
    // Added: Verify login page is shown again after logout
